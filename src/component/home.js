...
class Home extends Component {
    ...
    <h2><b><button type="button" class="btn btn-outline-warning waves-effect">Thời Trang Nam</button></b></h2>
    <div className="row ">
          
        <ProductList>
            {search.map((product,index) => {
                if( product.loaiquanao === 'Thời trang nam' ){
                    return(
                        <ProductItem 
                            key={index}
                            product={product}
...
<div className="col-12 ">
<h2><b><button type="button" class="btn btn-outline-default waves-effect">Thời Tranng nữ</button></b></h2>
<div className="row ">
